...
Welcome to the r0astr learning path. Start here to understand how r0astr works and create your first patterns.
...
-   :material-music-note:{ .lg .middle } **Pattern Syntax**
    ...
    Learn mini notation and common pattern functions.

    [:octicons-arrow-right-24: Learn Patterns](patterns.md)
...
Check out the [Pattern Library](pattern-library.md) for copy-paste examples organized by category.
