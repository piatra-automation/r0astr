...
- **⚠️ CRITICAL WARNING:** Module uses REGEX parsing ONLY - DO NOT use transpiler() (it hangs in master context)
- **Module Structure:**
...
- **Regex Parsing Pattern (NO TRANSPILER):**
 ...
 - Example: `let SLIDER_LPF = slider(800, 100, 5000);` → varName='SLIDER_LPF', value=800, min=100, max=5000
...
- **TEMPO Special Handling:**
 ...
 - Example: TEMPO=30 CPM → 0.5 CPS, 120 BPM
 - Logs: ` Tempo: 30.0 CPM (120 BPM, 0.500 CPS)`
- **Event Bus Integration:**
 - **Emits:**
...
- **Delegation to Managers:**
 ...
 - Panel state save → panelManager.savePanelStateNow()
...
- **Result:** All acceptance criteria met (AC 1-6 ✓), master panel coordinator complete
